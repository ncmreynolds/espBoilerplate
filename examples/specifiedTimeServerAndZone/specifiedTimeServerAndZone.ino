...
void setup() {
  ...
  espBoilerplate.configureNtp("pool.ntp.org");                  //Optionally, enable NTP for a specific time server
  espBoilerplate.configureTimeZone("GMT0BST,M3.5.0/1,M10.5.0"); //Optionally, configure the specific timezone in IANA format, see https://raw.githubusercontent.com/nayarsystems/posix_tz_db/master/zones.csv for the list
